...
-- ── DBM page
L["DBM_TITLE"]          = "|cff4db8ffDBM|r  — Бэкапы"
L["DBM_BTN_SAVE"]       = "+ Сохранить профиль DBM"
L["DBM_EMPTY"]          = "|cff333340Бэкапов DBM пока нет.\n\n|r" ..
                          "|cff404050Настройте DBM, затем нажмите  |r|cff4db8ff+ Сохранить профиль DBM|r" ..
                          "|cff404050  выше.|r"
L["DBM_META"]           = "|cff353545Профиль DBM  ·  %s|r"
L["DBM_ERR_NOT_LOADED"] = "DBM не загружен."
L["DBM_ERR_DUPLICATE"]  = "Профиль '%s' уже сохранён."
L["DBM_ERR_NO_DATA"]    = "DBM найден, но данные профиля не удалось прочитать. Попробуй сначала открыть DBM через /dbm."
L["DBM_PRINT_SAVED"]    = "Профиль DBM '%s' сохранён."
L["DBM_BTN_W"]          = 210
...
L["IMP_DBM_ERR_NOT_LOADED"]  = "DBM не загружен."
L["IMP_DBM_ERR_NO_DATA"]     = "Нет данных для восстановления."
L["IMP_DBM_RESTORED"]        = "Профиль DBM '%s' восстановлен."
L["IMP_DBM_PROMPT"]          = "DBM '%s' восстановлен. Перезагрузите интерфейс."
...
L["MAIN_HOW_DBM"]      = "|cff4db8ff•|r |cffaaaaaa DBM|r       |cff505060— сохраняй настройки DBM; восстанавливай в один клик|r"
...
L["SYNC_S4_TEXT"]   = "Все твои WeakAuras, ElvUI, Skada и DBM бэкапы\nтеперь доступны на каждом аккаунте."
...
L["HELP_FEAT_DBM"]           = "DBM"
L["HELP_FEAT_DBM_DESC"]      = "Сохраняет настройки Deadly Boss Mods и восстанавливает их на любом персонаже. " ..
                               "Профиль называется по имени персонажа. Для применения нужна перезагрузка интерфейса."
