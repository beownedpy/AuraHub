...
-- DBM page
L["DBM_TITLE"]          = "|cff4db8ffDBM|r  — Backups"
L["DBM_BTN_SAVE"]       = "+ Save DBM Profile"
L["DBM_EMPTY"]          = "|cff333340No DBM backups saved yet.\n\n|r" ..
                          "|cff404050Configure DBM, then click  |r|cff4db8ff+ Save DBM Profile|r" ..
                          "|cff404050  above.|r"
L["DBM_META"]           = "|cff353545DBM profile  ·  %s|r"
L["DBM_ERR_NOT_LOADED"] = "DBM is not loaded."
L["DBM_ERR_DUPLICATE"]  = "Profile '%s' is already saved."
L["DBM_ERR_NO_DATA"]    = "DBM found but no profile data could be read. Try /dbm to open DBM first."
L["DBM_PRINT_SAVED"]    = "DBM profile '%s' saved."
...
L["IMP_DBM_ERR_NOT_LOADED"]  = "DBM is not loaded."
L["IMP_DBM_ERR_NO_DATA"]     = "No data to restore."
L["IMP_DBM_RESTORED"]        = "DBM profile '%s' restored."
L["IMP_DBM_PROMPT"]          = "DBM '%s' restored. Reload UI to apply changes."
...
L["MAIN_HOW_DBM"]      = "|cff4db8ff•|r |cffaaaaaa DBM|r       |cff505060— snapshot your DBM settings; restore with one click|r"
...
L["SYNC_S4_TEXT"]   = "All your WeakAuras, ElvUI, Skada and DBM backups\n" ..
...
L["HELP_FEAT_DBM"]           = "DBM"
L["HELP_FEAT_DBM_DESC"]      = "Save your Deadly Boss Mods settings and restore them on any character. " ..
                               "Profile is named after your character. Requires a UI reload to apply."
